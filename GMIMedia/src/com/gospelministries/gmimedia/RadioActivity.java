...
public class RadioActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        VideoStream videoStream_data[] = new VideoStream[] {
            new VideoStream(R.drawable.ve, "Radio La Voz"),
            new VideoStream(R.drawable.gd, "GFN Radio"),
            new VideoStream(R.drawable.bo, "Radio Altiplano"),
            new VideoStream(R.drawable.br, "Terceiro Anjo")
        };

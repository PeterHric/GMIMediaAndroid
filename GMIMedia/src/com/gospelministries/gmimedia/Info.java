...
public class Info extends Activity {
    ...
    // TODO: mtneug this should be in Strings
    public final static String ABOUT_TEXT =
        "Gospel Ministries International is a faith-based, volunteer-driven organization which seizes opportunities to carry God's love, through sacrifice, to the world.\n\n" +
            "- Education\n" +
            "- Prison Ministry\n" +
            "- Healthcare\n" +

...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Define video streams and their rtsp ULRs with resolution in the
        // following order Low, Medium, High null denotes, there is no available
        // stream yet with particular resolution
        aVideoStreams = new VideoStream[] {
            new VideoStream(R.drawable.us, "Mission TV USA - English",
                "rtsp://streamer1.streamhost.org:1935/salive/GMImissiontvl",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/GMImissiontvh"),

            new VideoStream(R.drawable.ph, "HCBN Philippines - English",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIhcbnl",
                null,
                null),

            new VideoStream(R.drawable.gd, "Global Family Network Grenada - English",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/GMIgfnm",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIgfnh"),

            new VideoStream(R.drawable.ke, "2CBN Kenya - English",
                "rtsp://streamer1.streamhost.org:1935/salive/GMI2cbnl",
                "rtsp://streamer1.streamhost.org:1935/salive/GMI2cbnm",
                "rtsp://streamer1.streamhost.org:1935/salive/GMI2cbnh"),

            new VideoStream(R.drawable.bo, "Red ADvenir Bolivia - Spanish",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIredadvenirl",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIredadvenirm",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIredadvenirh"),

            new VideoStream(R.drawable.es, "Alfa Television Spain - Spanish",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIalfal",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIalfam",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIalfah"),

            new VideoStream(R.drawable.hu, "Light Channel Hungary - Hungarian",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/hungarian",
                null),

            new VideoStream(R.drawable.ro, "Light Channel Rumania - Romanian",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/romanian",
                null),

            new VideoStream(R.drawable.de, "Light Channel Germany - German",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/lctvde",
                null),

            new VideoStream(R.drawable.br, "Terceiro Anjo Brasil - Portuguese",
                "rtsp://streamer1.streamhost.org:1935/salive/GMI3anjol",
                "rtsp://streamer1.streamhost.org:1935/salive/GMI3anjom",
                "rtsp://streamer1.streamhost.org:1935/salive/GMI3anjoh"),

            new VideoStream(R.drawable.id, "HCBN Indonesia - Bahasa Indonesia",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIhcbnINlow",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIhcbnINmed",
                "rtsp://streamer1.streamhost.org:1935/salive/GMIhcbnINhigh"),

            new VideoStream(R.drawable.fr, "TV Famille France - French",
                "rtsp://streamer1.streamhost.org:1935/salive/GMItvfl",
                "rtsp://streamer1.streamhost.org:1935/salive/GMItvfm",
                "rtsp://streamer1.streamhost.org:1935/salive/GMItvfh"),

            new VideoStream(R.drawable.it, "Light Channel Italy - Italian",
                "rtsp://streamer1.streamhost.org:1935/salive/lcit",
                null,
                null),

            new VideoStream(R.drawable.sk, "Light Channel Slovakia - Music",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/lctvcz",
                null),

            new VideoStream(R.drawable.cz, "Light Channel Czech Republic - Music",
                null,
                "rtsp://streamer1.streamhost.org:1935/salive/lctvcz",
                null),

            new VideoStream(R.drawable.nl, "Light Channel Nederlanden - Dutch",
                "rtsp://streamer1.streamhost.org:1935/salive/GMILightNLL",
                "rtsp://streamer1.streamhost.org:1935/salive/GMILightNLM",
                "rtsp://streamer1.streamhost.org:1935/salive/GMILightNLH"),

            // ToDo:
            //new VideoStream(R.drawable.ve, "Dummy - Light Channel Venezuela")
        };
        ...
        tvChannelListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parentAdapter, View view, final int tvPosition, long id) {
                ...
                // Align position given click and position in the stream arrays
                int tvArrayIndex = tvPosition - 1;

                ArrayList<Boolean> resolOptions = getResOptions(tvArrayIndex, numOptions);

                if (!resolOptions.isEmpty())
                    launchVideo(resolOptions, numOptions[0], tvArrayIndex,
                        Video_Low_Mission.class);
            }
        });
    }
    ...
    ArrayList<Boolean> getResOptions(final int selectedTV, int[] numOptions) {
        ...
        for (Boolean resolution : resolOptions) {
            if (resolution) numOptions[0]++;
        }
    ...
    private boolean launchVideo(List<Boolean> resolOptions, int numResOptions, final int selectedTV, final Class ministryClass) {
        // Only available options (i.e. not null)
        final CharSequence[] resOptsItems = new CharSequence[numResOptions];
